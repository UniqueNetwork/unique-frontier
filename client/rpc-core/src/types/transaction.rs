	...
	fn build_from(from: H160, transaction: &EthereumTransaction) -> Self {
		...
		match transaction {
			EthereumTransaction::Legacy(t) => Self {
				...
				r: U256::from_little_endian(t.signature.r().as_bytes()),
				s: U256::from_little_endian(t.signature.s().as_bytes()),
			},
			EthereumTransaction::EIP2930(t) => Self {
				...
				r: U256::from_little_endian(t.r.as_bytes()),
				s: U256::from_little_endian(t.s.as_bytes()),
			},
